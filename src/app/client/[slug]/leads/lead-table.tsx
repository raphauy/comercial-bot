...
export function DataTableToolbar<TData>({ table }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex items-center gap-1 dark:text-white">
      ...
      <Input className="max-w-xs" placeholder="filtrar razon social..."
      ...
      <Input className="max-w-xs" placeholder="filtrar id..."
...
export function DataTable<TData, TValue>({
  ...
  React.useEffect(() => {
    ...
    leadId && table.getColumn("id")?.setFilterValue(leadId)
